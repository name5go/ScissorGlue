...
public:
	...
	*/
	...
	/**
		@brief
		\~English this method is called when load Assets
	...
	*/
	...
	/**
	@brief
	\~English this method is called when unload Assets
	...
	*/
	...
	/**
	\~English get whether Assets are loaded automatically when a binary is loaded
...
*/
	...
	*/
	...
	/**
		...
		If reloadingThreadType is RenderThread, new Assets aren't loaded and old Assets aren't disposed.
		\~Japanese
...
public:
	...
	*/
	...
	/**
		@brief
		\~English	Specifies whether caching of file Assets is enabled.
